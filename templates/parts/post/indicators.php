...
<div class="post__buttons">
    ...
    <a class="post__indicator post__indicator--comments button" href="/post.php?post_id=<?= htmlspecialchars($post["id"]) ?>"
       title="Комментарии">
    ...
    <a class="post__indicator post__indicator--repost button" href="/repost.php?post_id=<?= htmlspecialchars($post["id"]) ?>" title="Репост">
        <svg class="post__indicator-icon" width="19" height="17">
