            ...
            <li class="post-mini <?= htmlspecialchars($like["post_type"]) ?> post user">
                <div class="post-mini__user-info user__info">
                    <div class="post-mini__avatar user__avatar">
                        <a class="user__avatar-link"
                           href="/profile.php?author_id=<?= htmlspecialchars($like["user_id"]) ?>">
                            <img class="post-mini__picture user__picture"
                                 src="<?= htmlspecialchars($like["avatar"]) ?>" alt="Аватар пользователя">
                        </a>
                    </div>
                    <div class="post-mini__name-wrapper user__name-wrapper">
                        ...
                        <div class="post-mini__action">
                            ...
                            <time
                                ...
                                datetime="<?= htmlspecialchars($like["date_title"]) ?>"
                            >
                                <?= htmlspecialchars($like["time_ago"]) ?>
                            </time>
                        </div>
                    </div>
                </div>
                <div class="post-mini__preview">
                    <a class="post-mini__link"
                       href="/post.php?post_id=<?= htmlspecialchars($like["post_id"]) ?>" title="Перейти на публикацию">
                        <?php
