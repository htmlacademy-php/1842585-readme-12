            ...
            <div class="profile__user-info user__info">
                ...
                <div class="profile__name-wrapper user__name-wrapper">
                    ...
                    <time
                        ...
                        datetime="<?= htmlspecialchars($author["date_title"]) ?>"
                    >
                        <?= htmlspecialchars($author["time_ago"]) ?>
                    </time>
                </div>
            </div>
            <?php print($user_info) ?>
                ...
                <ul class="profile__tabs-list filters__list tabs__list">
                    <li class="profile__tabs-item filters__item">
                        <a class="profile__tabs-link filters__button tabs__item
                                <?= $tab === "posts" ? "filters__button--active tabs__item--active" : "" ?> button"
                           href="/profile.php?author_id=<?= htmlspecialchars($author["id"]) ?>"
                        >Посты</a>
                    </li>
                    <li class="profile__tabs-item filters__item">
                        <a class="profile__tabs-link filters__button tabs__item
                                <?= $tab === "likes" ? "filters__button--active tabs__item--active" : "" ?> button"
                           href="/profile.php?author_id=<?= htmlspecialchars($author["id"]) ?>&tab=likes"
                        >Лайки</a>
                    </li>
                    <li class="profile__tabs-item filters__item">
                        <a class="profile__tabs-link filters__button tabs__item
                                <?= $tab === "subscriptions" ? "filters__button--active tabs__item--active" : "" ?>
                                button"
                           href="/profile.php?author_id=<?= htmlspecialchars($author["id"]) ?>&tab=subscriptions"
                        >Подписки</a>
                    </li>
                </ul>
            </div>
