 ...
 * @var $post array{id: string, title: string, type: string, contain: string, user_name: string, avatar: string, views_count:string, created_date:string, time_ago: string, date_title: string} - пост пользователя
 */
            ...
            <div class="post-details__user user">
                <div class="post-details__user-info user__info">
                    ...
                    <div class="post-details__name-wrapper user__name-wrapper">
                        ...
                        <time class="post-details__time user__time" title="<?= htmlspecialchars($post["date_title"]) ?> datetime="<?= htmlspecialchars($post["created_date"]) ?>"><?= htmlspecialchars(
                            $post["time_ago"]
                        ) ?></time>
                    </div>
                </div>
