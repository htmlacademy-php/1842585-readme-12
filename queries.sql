...
-- Добавление постов
INSERT INTO posts (created_at, title, content, author, user_id, type_id, views_count, preview)
VALUES ("2021-02-25T22:38:18", "Цитата", "Мы в жизни любим только раз, а после ищем лишь похожих", "Лариса", 1, 1, 18, null),
       ...
       ("2021-06-15T22:38:18", "Игра престолов", "Не могу дождаться начала финального сезона своего любимого сериала!",
        "Владик", 3, 5, 2, null),
       ("2021-07-15T22:38:18", "Наконец, обработал фотки!", "img/rock-medium.jpg", "Виктор", 2, 3, 139, "img/rock-medium.jpg"),
       ("2021-08-13T22:38:18", "Моя мечта", "img/coast-medium.jpg", "Лариса", 1, 3, 14, "img/coast-medium.jpg"),
       ("2021-09-01T22:38:18", "Лучшие курсы", "www.htmlacademy.ru", "Владик", 3, 2, 49, null);
...
INSERT INTO likes (user_id, post_id, like_at)
VALUES (3, 3, '2021-09-13T22:38:18');

-- Лариса подписалась на Виктора
INSERT INTO subscribes (author_id, subscribe_id, subscribe_at)
VALUES (2, 1, '2021-09-13T22:38:18');
